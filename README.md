...
- Clear, modular functions with single responsibility make this suitable for a short project description.
- The tokenizer demonstrates understanding of lexing basics: token categorization, comment handling, and string parsing.

License
- Public domain for educational/demo use.
